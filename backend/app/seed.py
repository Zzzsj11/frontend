        ...
        defaults = [
            ...
            (
                ...
                "kling-v3",
                {
                    ...
                    "resolutions": ["720p", "1080p"],
                    "resolutionLabels": {"720p": "720P", "1080p": "1080P"},
                    "providerResolutionMap": {"720p": "720P", "1080p": "1080P"},
            ...
            (
                "model-happyhorse-11-t2v",
                provider.id,
                "happyhorse-1.1-t2v",
                "HappyHorse 1.1 文生（英和）",
                "video",
                "happyhorse-1.1-t2v",
                {
                    "durations": {"min": 4, "max": 15},
                    ...
                    "resolutions": ["720p", "1080p"],
                    "providerResolutionMap": {"720p": "720P", "1080p": "1080P"},
                    "referenceImage": {"min": 0, "max": 0},
                    "referenceVideo": {"min": 0, "max": 0},
                    "referenceAudio": {"min": 0, "max": 0},
                    "providerProtocol": "happyhorse-native",
                    "nativeAudio": False,
                    "executionPool": "yinghe-happyhorse",
                    "executionConcurrency": 50,
                    "providerCode": "yinghe",
                    "billing": video_estimate_policy("happyhorse-1.1-t2v").capability(),
                    "sortOrder": 24,
                },
                False,
            ),
            (
                "model-happyhorse-11-i2v",
                provider.id,
                "happyhorse-1.1-i2v",
                "HappyHorse 1.1 图生（英和）",
                "video",
                "happyhorse-1.1-i2v",
                {
                    "durations": {"min": 4, "max": 15},
                    ...
                    "executionConcurrency": 50,
                    "providerCode": "yinghe",
                    "billing": video_estimate_policy("happyhorse-1.1-i2v").capability(),
                    "sortOrder": 25,
                },
                False,
            ),
            (
                "model-happyhorse-11-r2v",
                provider.id,
                "happyhorse-1.1-r2v",
                "HappyHorse 1.1 参考生（英和）",
                "video",
                "happyhorse-1.1-r2v",
                {
                    "durations": {"min": 4, "max": 15},
                    ...
                    "executionConcurrency": 50,
                    "providerCode": "yinghe",
                    "billing": video_estimate_policy("happyhorse-1.1-r2v").capability(),
                    "sortOrder": 26,
                },
                False,
            ),
            ...
            (
                ...
                "viduq3-turbo",
                {
                    ...
                    "referenceImage": {"min": 0, "max": 2},
                    "referenceVideo": {"min": 0, "max": 0},
                    "referenceAudio": {"min": 0, "max": 0},
                    "referenceTotalMax": 2,
                    "providerProtocol": "viduq3-toapis",
                    "nativeAudio": True,
                    "executionPool": "toapis-viduq3",
                    "executionConcurrency": 2,
                    "providerCode": "toapis",
                    "billing": video_estimate_policy("viduq3-turbo").capability(),
                    "sortOrder": 33,
                },
                False,
            ),
            (
                "model-viduq3-pro-toapis",
                toapis_provider.id,
                "viduq3-pro",
                "Vidu Q3 Pro（ToAPIs）",
                "video",
                "viduq3-pro",
                {
                    ...
                    "executionConcurrency": 2,
                    "providerCode": "toapis",
                    "billing": video_estimate_policy("viduq3-pro").capability(),
                    "sortOrder": 34,
                },
                False,
            ),
            (
                "model-viduq3-reference-toapis",
                toapis_provider.id,
                "viduq3",
                "Vidu Q3 参考生（ToAPIs）",
                "video",
                "viduq3",
                {
                    ...
                    "executionConcurrency": 2,
                    "providerCode": "toapis",
                    "billing": video_estimate_policy("viduq3").capability(),
                    "sortOrder": 35,
                },
                False,
            ),
