...
class Settings:
    ...
    worker_stale_seconds: int = max(60, int(os.getenv("WORKER_STALE_SECONDS", "180")))
    ...
    business_balance_cache_seconds: int = max(5, int(os.getenv("BUSINESS_BALANCE_CACHE_SECONDS", "60")))
    balance_force_coalesce_seconds: int = max(0, int(os.getenv("BALANCE_FORCE_COALESCE_SECONDS", "10")))
    business_key_quota_cache_seconds: int = max(30, int(os.getenv("BUSINESS_KEY_QUOTA_CACHE_SECONDS", "300")))
    business_key_quota_stale_seconds: int = max(30, int(os.getenv("BUSINESS_KEY_QUOTA_STALE_SECONDS", "900")))
