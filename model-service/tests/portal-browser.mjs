...
try {
 ...
 await expect(user.getByText('本月已用 0 · 预占 0 · 当前可用 1000',{exact:true})).toBeVisible()
...
`],{PYTHONPATH:path.join(root,'public-api')})
 ...
 await expect(user.getByText(/本月已用 20(?![.\d])/).first()).toBeVisible()
 await expect(user.getByText(/可用 980(?![.\d])/).first()).toBeVisible()
