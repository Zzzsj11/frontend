...
function mapScriptLine(item: Record<string, unknown>): ScriptLine {
  ...
  return {
    ...
    optimizedPrompt: item.optimizedPrompt as string | undefined,
    referenceMedia: item.referenceMedia as ScriptLine['referenceMedia'],
    optimizerProvider: item.optimizerProvider as ScriptLine['optimizerProvider'],
    optimizationTaskId: item.optimizationTaskId as string | undefined,
